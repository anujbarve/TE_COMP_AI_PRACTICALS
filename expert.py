...
skills["productivity"],
skills["leadership"],
skills.get("coding_skills", 0) # Use get method to handle the case when
"coding_skills" is not present
)
...
skill = input("Enter the skill name (presentation, communication,
productivity, leadership): ").lower()
