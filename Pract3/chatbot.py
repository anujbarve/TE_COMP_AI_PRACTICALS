...
track_order_data = {
    "johndoe@mail.com" : "on the way",
    "michaellee@mail.com" : "delivered",
    "walterwhite@mail.com" : "preparing",
}
...
def get_offers():
    ...
    print("1. Refer to your friend and get 200 in your ScanEat Wallet ")
